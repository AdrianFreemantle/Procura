...
S101_CONTEXT: SectionContextBase = GenericSectionContext(
    ...
    section_title="Purchaser's Objectives",
    section_purpose="A High-Level explanation of why the Purchaser needs the goods. Helps the Supplier understand what the Purchaser is trying to achieve and sets the context for evaluating the suitability of the goods.",
    interview_guidance="Focus on HIGH-LEVEL business drivers, not features or specifics",
    validation_report=[],
    summary_presented=False,
    purchaser_confirmed=False,
